...
def mine_unconfirmed_transactions():
    ...
    if not result:
        ...
        # Making sure we have the longest chain before announcing to the
        # network
        ...
        return "Block #{} is mined. Your vote is now registered, you can close this page safely".format(blockchain.last_block.index)
